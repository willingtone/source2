...
<div class="panel panel-gradient" >
                ...
                <div class="panel-heading">
                    <div class="panel-title">
					 <?php echo get_phrase('transport_information_page'); ?>
					</div>
					</div>
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/transport/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo get_phrase('route_name');?></label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="route_name"/>
                                </div>
                            
                                <label class="col-sm-2 control-label"><?php echo get_phrase('number_of_vehicle');?></label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-2 control-label"><?php echo get_phrase('route_fare');?></label>
                                <div class="col-sm-3">
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="entypo-location"></i><?php echo get_phrase('add_transport');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
