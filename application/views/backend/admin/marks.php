...
<br>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                	<tr>
                        <td style="color: blue; text-transform: capitalize;"><?php echo get_phrase('select_exam');?></td>
                        <td style="color: blue; text-transform: capitalize;"><?php echo get_phrase('select_class');?></td>
                        <td style="color: blue; text-transform: capitalize;"><?php echo get_phrase('select_subject');?></td>
                        <td>&nbsp;</td>
                	</tr>
                	<tr>
                        <td>
...
<button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="entypo-check"></i><?php echo get_phrase('manage_marks');?></button>
                        </td>
                	</tr>
                </table>
                </form>
                ...
                <table class="table table-bordered" >
                  ...
                  <center>
<button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="entypo-check"></i><?php echo get_phrase('update_marks');?></button>
                  </center>
				  <br><br>
                  <?php echo form_close();?>
