                ...
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?admin/class_routine/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            <div class="form-group">
                                <label class="col-sm-1 control-label"><?php echo get_phrase('class');?></label>
                                <div class="col-sm-3">
                                ...
                                <label class="col-sm-1 control-label"><?php echo get_phrase('subject');?></label>
                                <div class="col-sm-3">
                                ...
                                <label class="col-sm-1 control-label"><?php echo get_phrase('day');?></label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="ending_ampm" class="form-control" style="width:100%;">
                                        <option value="1" style=" background-color: orange">am</option>
                                        <option value="2" style=" background-color: orange">pm</option>
                                    </select>
                                </div>
                            </div>
                        <div class="form-group">
