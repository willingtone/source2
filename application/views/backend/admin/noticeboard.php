...
<div class="panel panel-gradient" >
                ...
                <div class="panel-heading">
                    <div class="panel-title">
					 <?php echo get_phrase('noticeborad_information_page'); ?>
					</div>
					</div>
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/noticeboard/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            <div class="form-group">
                                ...
                                <label class="col-sm-2 control-label"><?php echo get_phrase('notice');?></label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-2 control-label"><?php echo get_phrase('send_sms_to_all');?></label>
                                <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="entypo-pencil"></i><?php echo get_phrase('add_notice');?></button>
                            </div>
						</div>
                    </form>                
                </div>                
