            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'student_add') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/student_add">
                        <span><i class="entypo-users"></i> <?php echo get_phrase('admit_student'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'student_bulk_add') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/student_bulk_add">
                        <span><i class="entypo-users"></i> <?php echo get_phrase('admit_bulk_student'); ?></span>
                    </a>
                </li>
            ...
            <ul>
                <li class="<?php if ($page_name == 'class') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/classes">
                        <span><i class="entypo-target"></i> <?php echo get_phrase('manage_classes'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'section') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/section">
                        <span><i class="entypo-target"></i> <?php echo get_phrase('manage_sections'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'academic_syllabus') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/academic_syllabus">
                        <span><i class="entypo-target"></i> <?php echo get_phrase('academic_syllabus'); ?></span>
                    </a>
                </li>
                <!-- CLASS ROUTINE -->
...
<li class="<?php
        if ($page_name == 'all_enquiries' ||
                $page_name == 'enquiry_setting')
            echo 'opened active';
        ?> ">
            <a href="#">
                <i class="entypo-flow-tree"></i>
                <span><?php echo get_phrase('manage_enquiries'); ?></span>
            </a>
            <ul>
		 <!-- ENQUIRY TABLE INFO -->
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo get_phrase('manage_examination'); ?></span>
            </a>
            <ul>
                <!-- AASIGNMENTS -->
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'exam') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/exam">
                        <span><i class="entypo-graduation-cap"></i> <?php echo get_phrase('exam_list'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'grade') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/grade">
                        <span><i class="entypo-graduation-cap"></i> <?php echo get_phrase('exam_grades'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'marks') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/marks">
                        <span><i class="entypo-graduation-cap"></i> <?php echo get_phrase('manage_marks'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'exam_marks_sms') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/exam_marks_sms">
                        <span><i class="entypo-graduation-cap"></i> <?php echo get_phrase('send_marks_by_sms'); ?></span>
                    </a>
                </li>
                 <li class="<?php if ($page_name == 'exam_result_list') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/exam_result_list">
                        <span><i class="entypo-graduation-cap"></i> <?php echo get_phrase('view_result'); ?></span>
                    </a>
                </li>  
                <li class="<?php if ($page_name == 'tabulation_sheet') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/tabulation_sheet">
                        <span><i class="entypo-graduation-cap"></i> <?php echo get_phrase('tabulation_sheet'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
