...
<div class="x_panel" >
                ...
                <div class="x_title">
                    <div class="panel-title">
					 <?php echo get_phrase('attendance_information_page'); ?>
					</div>
					</div>
<br>
...
<button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="entypo-plus"></i><?php echo get_phrase('manage_attendance');?></button>
...
<form method="post" 
    action="<?php echo base_url();?>index.php?admin/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
        <div class="col-sm-offset-0 col-md-12">
            ...
            <center>
<button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="entypo-book"></i><?php echo get_phrase('save_changes');?></button>
            </center>
        </div>
