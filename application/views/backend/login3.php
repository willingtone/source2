...
var baseurl = '<?php echo base_url();?>';
	...
	<div class="login-form">
		...
		<div class="login-content">
		    ...
		    <form class="login-form" method="post" role="form" id="form_login">
  ...
  <div class="form-group">
    ...
    <button type="submit" class="btn btn-login float-right"><i class="entypo-login"></i>Login Now</button>
  </div>
...
<!--<div class="copy-text">Created with <i class="fa fa-heart"></i> by <a href="http://grafreez.com">Grafreez.com</a></div>
    ...
    <div class="carousel-item active">
      <img class="d-block img-fluid" src="../../../uploads/login_image/people-coffee-tea-meeting.jpg" alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block img-fluid" src="../../../uploads/login_image/pexels-photo.jpg" alt="First slide">
      <div class="carousel-caption d-none d-md-block">
        <div class="banner-text">
            <h2>This is Heaven</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p>
    ...
    <div class="carousel-item">
      <img class="d-block img-fluid" src="../../../uploads/login_image/pexels-photo-872957.jpeg" alt="First slide">
      <div class="carousel-caption d-none d-md-block">
        <div class="banner-text">
            <h2>This is Heaven</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p>
